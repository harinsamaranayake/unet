...
def unet_8_rau(pretrained_weights=None, input_size=None):
    inputs = Input(input_size)
    ...
    conv1 = Conv2D(64, 3, activation='relu', padding='same',
                   kernel_initializer='he_normal')(RA_0_n)
    conv1 = Conv2D(64, 3, activation='relu', padding='same',
                   kernel_initializer='he_normal')(conv1)

    RA_1 = Lambda(lambda y: RA_unit_v4_0(
        x=y, h=y.shape[1].value, w=y.shape[2].value, n=16))
    RA_1_n = RA_1(conv1)
    ...
    RA_2 = Lambda(lambda y: RA_unit_v4_0(
        x=y, h=y.shape[1].value, w=y.shape[2].value, n=16))
    RA_2_n = RA_2(conv2)
    ...
    RA_3 = Lambda(lambda y: RA_unit_v4_0(
        x=y, h=y.shape[1].value, w=y.shape[2].value, n=16))
    RA_3_n = RA_3(conv3)
    ...
    RA_4 = Lambda(lambda y: RA_unit_v4_0(
        x=y, h=y.shape[1].value, w=y.shape[2].value, n=16))
    RA_4_n = RA_4(drop4)
    ...
    RA_5 = Lambda(lambda y: RA_unit_v4_0(
        x=y, h=y.shape[1].value, w=y.shape[2].value, n=16))
    RA_5_n = RA_5(drop5)

    up6 = Conv2D(512, 2, activation='relu', padding='same',
                 kernel_initializer='he_normal')(UpSampling2D(size=(2, 2))(RA_5_n))
    merge6 = concatenate([drop4, up6], axis=3)
    ...
    RA_6 = Lambda(lambda y: RA_unit_v4_0(
        x=y, h=y.shape[1].value, w=y.shape[2].value, n=16))
    RA_6_n = RA_6(conv6)

    up7 = Conv2D(256, 2, activation='relu', padding='same',
                 kernel_initializer='he_normal')(UpSampling2D(size=(2, 2))(RA_6_n))
    merge7 = concatenate([conv3, up7], axis=3)
    ...
    RA_7 = Lambda(lambda y: RA_unit_v4_0(
        x=y, h=y.shape[1].value, w=y.shape[2].value, n=16))
    RA_7_n = RA_7(conv7)

    up8 = Conv2D(128, 2, activation='relu', padding='same',
                 kernel_initializer='he_normal')(UpSampling2D(size=(2, 2))(RA_7_n))
    merge8 = concatenate([conv2, up8], axis=3)
    ...
    RA_8 = Lambda(lambda y: RA_unit_v4_0(
        x=y, h=y.shape[1].value, w=y.shape[2].value, n=16))
    RA_8_n = RA_8(conv8)

    up9 = Conv2D(64, 2, activation='relu', padding='same',
                 kernel_initializer='he_normal')(UpSampling2D(size=(2, 2))(RA_8_n))
    merge9 = concatenate([conv1, up9], axis=3)
    ...
    model_name = "UNet_8_RAU"

    return model, model_name


def unet_2d_rau(pretrained_weights=None, input_size=None):
    inputs = Input(input_size)
